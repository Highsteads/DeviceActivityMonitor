...
log("  2. Edit labels, add # to disable sensors you do not want")
log("  3. To permanently exclude a sensor: add its ID to 'excluded_ids' in the config")
log("  4. Remove # from any non-contact device lines you want to add")
log("  5. Reload: Plugins > Sensor Monitor > Reload Plugin")
